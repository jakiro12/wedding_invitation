...
// Corner rosa
    section_2_ctx.save();
    section_2_ctx.translate(150, 85);
    ...
    section_2_ctx.save();
    section_2_ctx.translate(60, 200);
    ...
    section_2_ctx.save();
    section_2_ctx.translate( 90,  175);
    ...
    section_2_ctx.save();
    section_2_ctx.translate(130, 110);
    ...
    section_2_ctx.save();
    section_2_ctx.translate( 100, 90);
    ...
    section_2_ctx.save();
    section_2_ctx.translate(120,150);
    ...
    section_2_ctx.save();
    section_2_ctx.translate( 70, 120);
    ...
    //Rosa Inferior
    section_2_ctx.save();
    section_2_ctx.translate( centerX*2 - 160, centerY*2 - 80);
    section_2_ctx.rotate((Math.sin(angleLeave * Math.PI / 240) * angleRotation + 230 ) * Math.PI / 180);  
    section_2_ctx.drawImage(mediumStickGreenImage, -(mediumStickLeaveCornerSize / 2), -(mediumStickLeaveCornerSize / 2), mediumStickLeaveCornerSize, mediumStickLeaveCornerSize);
    section_2_ctx.restore();

    section_2_ctx.save();
    section_2_ctx.translate(centerX*2 - 40, centerY*2 - 180);
    section_2_ctx.rotate((Math.sin(angleLeave * Math.PI / 240) * angleRotation + 320 ) * Math.PI / 180);  
    section_2_ctx.drawImage(mediumStickGreenImage, -(mediumStickLeaveCornerSize / 2), -(mediumStickLeaveCornerSize / 2), mediumStickLeaveCornerSize, mediumStickLeaveCornerSize);
    section_2_ctx.restore();

    section_2_ctx.save();
    section_2_ctx.translate(centerX*2 - 140, centerY*2 - 100 );
    section_2_ctx.rotate((Math.sin(angleLeave * Math.PI / 300) * angleRotation + 80 ) * Math.PI / 180);  
    section_2_ctx.drawImage(tinyGreenLeaveImage, -(tinyLeaveCornerSize / 2), -(tinyLeaveCornerSize / 2), tinyLeaveCornerSize, tinyLeaveCornerSize);
    section_2_ctx.restore();

    section_2_ctx.save();
    section_2_ctx.translate(centerX*2 - 110, centerY*2 - 70);
    section_2_ctx.rotate((Math.sin(angleLeave * Math.PI / 240) * angleRotation + 10 ) * Math.PI / 180);  // Rota el contexto con una animación suave
    section_2_ctx.drawImage(whiteLeaveImage, -(whiteLeaveCornerSize / 2), -(whiteLeaveCornerSize / 2), whiteLeaveCornerSize, whiteLeaveCornerSize);
    section_2_ctx.restore();

    section_2_ctx.save();
    section_2_ctx.translate( centerX*2 - 90,  centerY*2 - 170) ;
...
// Corner rosa
section_4_ctx.save();
section_4_ctx.translate(150, 85);
...
section_4_ctx.save();
section_4_ctx.translate(60, 200);
...
section_4_ctx.save();
section_4_ctx.translate( 90,  175);
...
section_4_ctx.save();
section_4_ctx.translate(130, 110);
...
section_4_ctx.save();
section_4_ctx.translate( 100, 90);
...
section_4_ctx.save();
section_4_ctx.translate(120,150);
...
section_4_ctx.save();
section_4_ctx.translate( 70, 120);
...
//Rosa Inferior
section_4_ctx.save();
section_4_ctx.translate( centerX*2 - 160, centerY*2 - 80);
section_4_ctx.rotate((Math.sin(angleLeave * Math.PI / 240) * angleRotation + 230 ) * Math.PI / 180);  
section_4_ctx.drawImage(mediumStickGreenImage, -(mediumStickLeaveCornerSize / 2), -(mediumStickLeaveCornerSize / 2), mediumStickLeaveCornerSize, mediumStickLeaveCornerSize);
section_4_ctx.restore();

section_4_ctx.save();
section_4_ctx.translate(centerX*2 - 40, centerY*2 - 180);
section_4_ctx.rotate((Math.sin(angleLeave * Math.PI / 240) * angleRotation + 320 ) * Math.PI / 180);  
section_4_ctx.drawImage(mediumStickGreenImage, -(mediumStickLeaveCornerSize / 2), -(mediumStickLeaveCornerSize / 2), mediumStickLeaveCornerSize, mediumStickLeaveCornerSize);
section_4_ctx.restore();

section_4_ctx.save();
section_4_ctx.translate(centerX*2 - 140, centerY*2 - 100 );
section_4_ctx.rotate((Math.sin(angleLeave * Math.PI / 300) * angleRotation + 80 ) * Math.PI / 180);  
section_4_ctx.drawImage(tinyGreenLeaveImage, -(tinyLeaveCornerSize / 2), -(tinyLeaveCornerSize / 2), tinyLeaveCornerSize, tinyLeaveCornerSize);
section_4_ctx.restore();

section_4_ctx.save();
section_4_ctx.translate(centerX*2 - 110, centerY*2 - 70);
section_4_ctx.rotate((Math.sin(angleLeave * Math.PI / 240) * angleRotation + 10 ) * Math.PI / 180);  // Rota el contexto con una animación suave
section_4_ctx.drawImage(whiteLeaveImage, -(whiteLeaveCornerSize / 2), -(whiteLeaveCornerSize / 2), whiteLeaveCornerSize, whiteLeaveCornerSize);
section_4_ctx.restore();

section_4_ctx.save();
section_4_ctx.translate( centerX*2 - 90,  centerY*2 - 170) ;
...
function animate_section_7(){
  ...
  let roseSize = 65;
    ...
    section_7_ctx.save();
    section_7_ctx.translate( centerX + 40 ,  70 );
    ...
    section_7_ctx.save();
    section_7_ctx.translate(centerX - 60 , 80 );
    ...
    section_7_ctx.save();
    section_7_ctx.translate(centerX - 25 , 60 )
    ...
    section_7_ctx.save();
    section_7_ctx.translate( centerX + 30 , 60 );
    ...
    section_7_ctx.save();
    section_7_ctx.translate(centerX + 30 ,  45 );
    section_7_ctx.rotate((Math.sin(angleLeave * Math.PI / 240) * angleRotation + 180 ) * Math.PI / 180);  
...
function animate_section_10(){
  ...
  let roseCornerSize = 100;
    ...
    section_10_ctx.save();  
    section_10_ctx.translate(0, 150);  
    ...
    section_10_ctx.lineWidth = 2;  
    section_10_ctx.save();  
    section_10_ctx.translate(0, centerY*2 - 20);  
    section_10_ctx.rotate(-13 * Math.PI / 180);  
    section_10_ctx.beginPath();
    section_10_ctx.moveTo(0, 0);
    section_10_ctx.lineTo(650, 0);
    ...
    section_10_ctx.lineWidth = 2;  
    section_10_ctx.save();  
    section_10_ctx.translate(0, centerY*2 - 150);  
    section_10_ctx.rotate(13 * Math.PI / 180);  
    section_10_ctx.beginPath();
    section_10_ctx.moveTo(0, 0);
    section_10_ctx.lineTo(650, 0);
...
// Corner rosa
section_10_ctx.save();
section_10_ctx.translate(150, 85);
...
section_10_ctx.save();
section_10_ctx.translate( 90,  175);
...
section_10_ctx.save();
section_10_ctx.translate(130, 110);
...
section_10_ctx.save();
section_10_ctx.translate( 100, 90);
...
section_10_ctx.save();
section_10_ctx.translate(120,150);
...
section_10_ctx.save();
section_10_ctx.translate(60, 95 );
...
section_10_ctx.save();
section_10_ctx.translate( 70, 120);
...
section_10_ctx.save();
section_10_ctx.translate(centerX*2 - 75, centerY*2 - 110);
...
function animate_section_14(){
  section_14_ctx.clearRect(0, 0, canvas_section_14.width, canvas_section_14.height);
    ...
    section_14_ctx.save();
    section_14_ctx.translate(centerX + 90, centerY - 110);
    ...
    section_14_ctx.save();
    section_14_ctx.translate(centerX + 145, centerY - 70);
    ...
    section_14_ctx.save();
    section_14_ctx.translate(centerX + 140, centerY - 90);
    ...
    section_14_ctx.save();
    section_14_ctx.translate(centerX + 70, centerY - 155);
    ...
    section_14_ctx.save();
    section_14_ctx.translate(centerX + 95, centerY - 152);
    ...
    section_14_ctx.save();
    section_14_ctx.translate(centerX + 95, centerY - 90);
    ...
    //Rosa del Lado izquierdo inferior
    section_14_ctx.save();
    section_14_ctx.translate(centerX - 95, centerY + 95);
    ...
    section_14_ctx.save();
    section_14_ctx.translate(centerX - 150, centerY + 55);
    ...
    section_14_ctx.save();
    section_14_ctx.translate(centerX - 65, centerY + 145);
    ...
    section_14_ctx.save();
    section_14_ctx.translate(centerX - 95, centerY + 130);
    ...
    section_14_ctx.save();
    section_14_ctx.translate(centerX - 145, centerY + 75);
    ...
    section_14_ctx.save();
    section_14_ctx.translate(centerX - 90, centerY + 90);
...
window.addEventListener("scroll", function() {
  ...
  const animateSection=this.document.querySelector('.section_14 > section')
